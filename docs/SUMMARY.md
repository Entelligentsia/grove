...
- [Install](install.md)
- [CLI & the seven tools](tools.md)
- [MCP: standard server](mcp.md)
- [MCP: explore mode (mcp-llm)](setup.md)
- [Languages & grammars](languages.md)
- [Use grove as a library](library.md)
